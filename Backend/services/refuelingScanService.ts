...
//         // Use a more generic model name or check for the correct one in the docs
//         const model = genAI.getGenerativeModel({ model: "gemini" }); // Use a more common or available model name
