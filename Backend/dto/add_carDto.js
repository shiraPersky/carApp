...
var CarDto = /** @class */ (function () {
    ...
    CarDto.update = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma.car.update({
                            where: { id: id },
                            data: {
    ...
    CarDto.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma.car.delete({
                            where: { id: id },
                        })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
    ...
    CarDto.updateOdometer = function (licensePlate, odometer) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma.car.update({
