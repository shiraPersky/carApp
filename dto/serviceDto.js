...
var ServiceDto = /** @class */ (function () {
    ...
    ServiceDto.create = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma.service.create({ data: data })];
    ...
    ServiceDto.getAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma.service.findMany()];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    ...
    ServiceDto.update = function (id, data) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ServiceDto.delete = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, prisma.service.delete({
                            where: { id: id },
                        })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
