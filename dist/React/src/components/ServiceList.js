...
const react_router_dom_1 = require("react-router-dom"); // For navigation
const react_1 = require("react"); // For state and side-effects
const serviceApi_1 = require("../services/serviceApi"); // API to fetch services
const react_2 = __importDefault(require("react"));
const ServiceList = () => {
    const [services, setServices] = (0, react_1.useState)([]); // State to hold the list of services
    (0, react_1.useEffect)(() => {
        const fetchServices = () => __awaiter(void 0, void 0, void 0, function* () {
            const data = yield (0, serviceApi_1.getServices)(); // Fetch services
